...
haversine_loop_cpp2 <- function(x, lat_center, lon_center, radius = 200) {
    .Call('_spatialrisk_haversine_loop_cpp2', PACKAGE = 'spatialrisk', x, lat_center, lon_center, radius)
}
