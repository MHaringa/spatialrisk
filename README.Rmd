...
```{r example3a, eval = TRUE, message = FALSE, warning = FALSE}
...
Its also possible to show the coordinates with for example the three highest concentrations:
...
neighborhood_gh_search(hconc, max.call = 7000, verbose = FALSE, highest_geohash = 3) %>%
  plot()
...
```{r example4b, eval = TRUE, message = FALSE, warning = FALSE}
...
```{r example4d, eval = TRUE, echo = FALSE}
