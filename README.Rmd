...
Direct optimisation of a prepared object provides a full geometric reference search for small validation problems; optimisation after candidate selection uses the screened production state.
