...
## Example 1
Find all observations in `Groningen` within a circle of a radius of 50m from the point (lon,lat) = (6.561561,53.21326):
...
## Example 2
Find for each row in `df` the sum of all observations in `Groningen` within a circle of a radius of 100m from the lon/lat pair:
