...
library(spatialrisk)
circle <- points_within_radius(Groningen, lon_center = 6.571561, 
...
conc <- radius_sum(df, Groningen, value = amount, radius = 100)
conc
...
hc <- concentration_hotspot(Groningen, 
                            value = "amount", 
                            radius = 200)
...
st <- Sys.time()
hc <- spatialrisk::concentration_hotspot(spatialrisk::Groningen, "amount")
print(Sys.time() - st)
...
hconc <- concentration_hotspot(Groningen, 
                               value = "amount", 
                               radius = 200, 
                               top_n = 3)
